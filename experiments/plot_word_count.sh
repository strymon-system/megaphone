...
for backend in ${backends[@]}; do
    ...
    for mode in ${modes[@]}; do
      ...
      multiplot="$multiplot; plot \"$experiment/latency-word_count_n2_w1_rounds${rounds}_batch${batch}_keys${keys}_closed_${mode}_${backend}\" using (\$1/1000000000):(\$2/1000) with lines lt rgb \"black\"; "
    done
