...
for mode in ${modes[@]}; do
  ...
  gnuplot -p -e "$common; set terminal pdf size 2.3,1.1; $plot" > plots/word_count_scaling_n02_w01_constant_${mode}_batch${batch}_keys${keys}_$COMMIT.pdf
done
...
gnuplot -p -e "$common; set terminal pdf size 3.5,1.1; $multiplot" > plots/word_count_scaling_n02_w01_constant_multiplot_batch${batch}_keys${keys}_$COMMIT.pdf
...
for mode in ${modes[@]}; do
  ...
  gnuplot -p -e "$common; set terminal pdf size 2.3,1.1; $plot" > plots/word_count_scaling_n02_w04_constant_${mode}_batch${batch}_keys${keys}_$COMMIT.pdf
done
...
gnuplot -p -e "$common; set terminal pdf size 3.5,1.1; $multiplot" > plots/word_count_scaling_n02_w04_constant_multiplot_batch${batch}_keys${keys}_$COMMIT.pdf
...
for mode in ${modes[@]}; do
  ...
  gnuplot -p -e "$common; set terminal pdf size 2.3,1.1; $plot" > plots/word_count_scaling_n02_w04_square_${mode}_batch${batch}_keys${keys}_$COMMIT.pdf
done
...
gnuplot -p -e "$common; set terminal pdf size 3.5,1.1; $multiplot" > plots/word_count_scaling_n02_w04_square_multiplot_batch${batch}_keys${keys}_$COMMIT.pdf
