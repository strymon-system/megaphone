...
experiment=results/dirtybc5939e52e15265b0b341d1f6d86877f7c8566d8_word_count-open-loop-one-all-one
(
  cd $experiment;
...
gnuplot -p -e "set terminal pdf size 2.3,1.1; $plot" > word_count_scaling_n02_w01_batch${batch}_keys${keys}_$COMMIT.pdf
